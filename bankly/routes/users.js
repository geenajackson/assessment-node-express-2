...
const { authUser, requireLogin, requireAdmin, sameUserOrAdmin } = require('../middleware/auth');
...
router.patch('/:username', authUser, requireLogin, sameUserOrAdmin, async function (
  req,
  res,
  next
) {
